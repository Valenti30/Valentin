#############################################################################
# Makefile for building: servidorAplicacionBaloncesto
# Generated by qmake (3.1) (Qt 5.9.7)
# Project:  servidorAplicacionBaloncesto.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile servidorAplicacionBaloncesto.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -Icompiled/include -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtSql -isystem /usr/include/qt5/QtCore -I. -I/usr/lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = servidorAplicacionBaloncesto1.0.0
DISTDIR = /home/usuario/C++/servidorAplicacionBaloncesto/.tmp/servidorAplicacionBaloncesto1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -pthread -lz -L/home/usuario/C++/servidorAplicacionBaloncesto/compiled/lib/ -lixwebsocket -lQt5Sql -L/usr/lib64 -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = 
...
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		servidorAplicacionBaloncesto.pro json.hpp \
		servidor.h \
		conexion.h \
		jugador.h \
		usuario.h servidor.cpp \
		conexion.cpp \
		jugador.cpp \
		usuario.cpp
QMAKE_TARGET  = servidorAplicacionBaloncesto
DESTDIR       = 
TARGET        = servidorAplicacionBaloncesto
...
Makefile: servidorAplicacionBaloncesto.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt5/mkspecs/features/yacc.prf \
		/usr/lib64/qt5/mkspecs/features/lex.prf \
		servidorAplicacionBaloncesto.pro \
		/usr/lib64/libQt5Sql.prl \
		/usr/lib64/libQt5Core.prl
	$(QMAKE) -o Makefile servidorAplicacionBaloncesto.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents json.hpp servidor.h conexion.h jugador.h usuario.h $(DISTDIR)/
	$(COPY_FILE) --parents servidor.cpp conexion.cpp jugador.cpp usuario.cpp $(DISTDIR)/
	$(COPY_FILE) --parents myapp_es_ES.ts $(DISTDIR)/
...
servidor.o: servidor.cpp compiled/include/ixwebsocket/IXWebSocketServer.h \
		compiled/include/ixwebsocket/IXSocketServer.h \
		compiled/include/ixwebsocket/IXConnectionState.h \
		compiled/include/ixwebsocket/IXSocketTLSOptions.h \
		compiled/include/ixwebsocket/IXWebSocket.h \
		compiled/include/ixwebsocket/IXProgressCallback.h \
		compiled/include/ixwebsocket/IXWebSocketCloseConstants.h \
		compiled/include/ixwebsocket/IXWebSocketErrorInfo.h \
		compiled/include/ixwebsocket/IXWebSocketHttpHeaders.h \
		compiled/include/ixwebsocket/IXCancellationRequest.h \
		compiled/include/ixwebsocket/IXWebSocketMessage.h \
		compiled/include/ixwebsocket/IXWebSocketCloseInfo.h \
		compiled/include/ixwebsocket/IXWebSocketMessageType.h \
		compiled/include/ixwebsocket/IXWebSocketOpenInfo.h \
		compiled/include/ixwebsocket/IXWebSocketPerMessageDeflateOptions.h \
		compiled/include/ixwebsocket/IXWebSocketSendInfo.h \
		compiled/include/ixwebsocket/IXWebSocketTransport.h \
		compiled/include/ixwebsocket/IXWebSocketHandshake.h \
		compiled/include/ixwebsocket/IXSocket.h \
		compiled/include/ixwebsocket/IXWebSocketInitResult.h \
		compiled/include/ixwebsocket/IXWebSocketPerMessageDeflate.h \
		jugador.h \
		json.hpp \
		servidor.h \
		usuario.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o servidor.o servidor.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/servidorAplicacionBaloncesto/bin || mkdir -p $(INSTALL_ROOT)/opt/servidorAplicacionBaloncesto/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/servidorAplicacionBaloncesto/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/servidorAplicacionBaloncesto/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/servidorAplicacionBaloncesto/bin/ 
